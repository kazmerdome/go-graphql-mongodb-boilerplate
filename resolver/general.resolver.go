...
func (r *mutationResolver) UpdateGeneral(ctx context.Context, where model.GeneralWhereUniqueInput, data gqlgen.GeneralUpdateInput) (*model.General, error) {
	item := model.General{}
	item.ID = where.ID
...
func (r *mutationResolver) DeleteGeneral(ctx context.Context, where model.GeneralWhereUniqueInput) (*model.General, error) {
	item := model.General{ID: where.ID}
